...
public class DeegreeDesktopEventHandler {
    ...
    static void actionPerformed( ApplicationContainer<Container> igeo, ActionEvent event ) {
        ...
        if ( eventName.startsWith( "$class:" ) ) {
            ...
            DeegreeDesktopEventHandler.invokeStaticEventHandler( igeo, eventName );
            ...
            DeegreeDesktopEventHandler.invokeModuleEventHandler( igeo, eventName );
        } else if ( "newproject".equals( eventName ) ) {
            DeegreeDesktopEventHandler.openNewProject( igeo );
        } else if ( "newprojectbyfile".equals( eventName ) ) {
            DeegreeDesktopEventHandler.createNewProjectByDataFile( igeo );
        } else if ( "open".equals( eventName ) ) {
            DeegreeDesktopEventHandler.loadProject( igeo );
            ...
            try {
                if ( igeo.isNew() ) {
                    DeegreeDesktopEventHandler.saveProject( igeo );
                } else {
                    DeegreeDesktopEventHandler.saveProject( igeo, null );
                }
            } catch ( Exception e ) {
                LOG.logError( e.getMessage(), e );
            ...
            DeegreeDesktopEventHandler.addMapModel( igeo );
        } else if ( "removeMapModel".equals( eventName ) ) {
            DeegreeDesktopEventHandler.removeMapModel( igeo );
        } else if ( "openMapModel".equals( eventName ) ) {
            DeegreeDesktopEventHandler.openMapModel( igeo );
